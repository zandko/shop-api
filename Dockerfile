...
# 创建app目录
RUN mkdir -p /usr/src/shop_interface
 
# 设置工作目录
WORKDIR /usr/src/shop_interface
...
COPY package.json /home/shop_interface/package.json
...
#  && cd /home/jenkins_home/workspace/shop_interface  \
#  && docker build --rm --no-cache=true  -t shop_interface  - < Dockerfile \
#  && docker run -d --privileged=true --name shop_interface -p 3000:3000 -v /home/jenkins_home/workspace/shop_interface:/usr/src/shop_interface
