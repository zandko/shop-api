...
# 创建app目录
RUN mkdir -p /home/lovePurchase/shop_interface

# 设置工作目录
WORKDIR /home/lovePurchase/shop_interface
...
COPY package.json /home/lovePurchase/shop_interface/package.json
...
# 拷贝所有源代码到工作目录
COPY . /home/lovePurchase/shop_interface
